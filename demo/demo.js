...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        null,
	        'The “pro tools” add new features to Literally Canvas on top of what it does by default. All tools and shapes are guaranteed to be compatible with a release of the main library at most 30 days old. All new shapes work with both the canvas and SVG if possible.'
	      ),
	      React.createElement(
	        'p',
	        null,
	        React.createElement(
	          'b',
	          null,
	          'The top-level API is not guaranteed to be stable.'
	        ),
	        ' But it is simple.'
	      ),
	      React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'tt',
	          null,
	          'lib/js/lc-pro-tools-standalone.js'
	        ),
	        ' on your web page. Then call ',
	        React.createElement(
	          'tt',
	          null,
	          'LCProTools.tools.addToDefaultTools(LC)'
	        ),
	        ' or add ',
	        React.createElement(
	          'tt',
	        ...
	        ' to the list of tools you pass to ',
	        React.createElement(
	          'tt',
	          null,
	          'LC.init()'
	      ...
	      React.createElement(
	        'p',
	        null,
	        'You’ll need to copy everything in ',
	        React.createElement(
	          'tt',
	          null,
	          'lib/img'
	        ),
	        ' to the same place as Literally Canvas’s stock images. (The same folder as, for example, ',
	        React.createElement(
	          'tt',
	          null,
	          'pencil.png'
	...
	React.render(React.createElement(BeforeLC, null), document.getElementById('before-lc'));
	React.render(React.createElement(AfterLC, null), document.getElementById('after-lc'));

	LC.init(document.getElementById('lc-container'), { imageURLPrefix: "demo/img" });
	...
	/***/function (module, exports) {
		...
		LC.defineOptionsStyle('flood-fill-options', React.createClass({
			...
			render: function render() {
				...
				return React.createElement('div', null, React.createElement('div', { style: floatLeft }, React.createElement('label', { style: floatLeft, htmlFor: 'threshold' }, 'Threshold:'), React.createElement('div', { style: containerStyle }, React.createElement('input', { id: 'threshold', type: 'range', min: 0, max: MAX_THRESHOLD,
					style: inputStyle, onChange: this.updateThreshold,
					value: this.state.threshold }), React.createElement('div', { style: valueStyle }, percent, '%'))));
			}
		}));
		...
		module.exports = function (_LC$tools$Tool) {
			...
			_createClass(FillTool, [{
				...
				value: function renderHelp() {
					return React.createElement('div', null, React.createElement('h2', null, 'Paint Bucket'), React.createElement('p', null, 'Click on a pixel. While any neighboring pixel is at least X% similar to the clicked pixel (as determined by the slider in the options toolbar), a neighboring pixel is set to the background color.'), React.createElement('p', null, 'The result is saved as an Image object.'), React.createElement('p', null, React.createElement('b', null, 'If the image is unbounded, the paint bucket will ignore all pixels outside the minimum bounding rect of all existing shapes.'), ' So if there are no shapes yet, it will do nothing.'));
				}
			}]);
	...
	/***/function (module, exports, __webpack_require__) {
		...
		LC.defineOptionsStyle('spraypaint-options', React.createClass({
			...
			render: function render() {
				...
				return React.createElement('div', null, React.createElement('div', { style: floatLeft }, React.createElement('label', { style: floatLeft, htmlFor: 'rate' }, 'Rate:'), React.createElement('div', { style: containerStyle }, React.createElement('input', { id: 'rate', type: 'range', min: 50, max: 400, style: inputStyle,
					onChange: this.updateRate,
					value: this.props.lc.tool.pointsPerSecond }), React.createElement('div', { style: valueStyle }, this.state.rate, ' px/sec'))), React.createElement('div', { style: { float: 'left', width: 10, height: 10 } }), React.createElement('div', { style: floatLeft }, React.createElement('label', { style: floatLeft, htmlFor: 'radius' }, 'Radius:'), React.createElement('div', { style: containerStyle }, React.createElement('input', { id: 'radius', type: 'range', min: 5, max: 200, style: inputStyle,
					onChange: this.updateRadius,
					value: this.props.lc.tool.radius }), React.createElement('div', { style: valueStyle }, this.state.radius, 'px'))));
			}
		}));
		...
		module.exports = function (_LC$tools$Tool) {
			...
			_createClass(Spraypaint, [{
				key: 'renderHelp',
				value: function renderHelp() {
					return React.createElement('div', null, React.createElement('h2', null, 'Spraypaint'), React.createElement('p', null, 'While the mouse button is down, add single-pixel-large points within X pixels of the cursor (determined by a slider) at a frequency of Y pixels per second (also determined by a slider).'), React.createElement('p', null, 'The result is saved as a ', React.createElement('tt', null, 'PointCollection'), ' shape, which is very efficient to render because it saves all the point as an image once the mouse button is released.'));
				}
			}]);
